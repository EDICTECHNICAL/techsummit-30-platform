// Copy and paste this entire script into the browser console on localhost:3000/admin

// Step 1: Set admin authentication cookie
document.cookie = "admin-auth=true";
console.log("✅ Admin cookie set! Refresh the page to access admin panel.");

// Step 2: After refreshing, run this function to seed all questions:
window.seedQuestionsViaAdmin = async function() {
  const quizQuestions = [
    {
  ...
  console.log("🚀 Starting to seed 15 quiz questions...");
  ...
  for (let i = 0; i < quizQuestions.length; i++) {
    ...
    console.log(`📝 Adding question ${i + 1}/15: ${question.text.substring(0, 50)}...`);
  ...
  console.log(`🎉 Finished! ${successCount} questions added successfully, ${failCount} failed.`);
  console.log("💡 Refresh the admin page to see the questions in the Quiz tab!");
};

// Show instructions
console.log(`
🎯 INSTRUCTIONS:
1. Refresh this page to access the admin panel
2. Navigate to the "Quiz" tab
3. Run: seedQuestionsViaAdmin()
4. Check the results!
`);