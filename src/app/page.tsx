...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative mobile-padding mx-auto max-w-6xl py-12 sm:py-20 lg:py-28">
          <div className="flex flex-col items-start gap-4 sm:gap-6">
            ...
            <div className="mobile-button-group">
              <Link href="/sign-up" className="event-button-primary rounded-md px-6 py-3 text-sm font-medium">
                Register Your Team
              </Link>
              <Link href="/sign-in" className="inline-flex items-center justify-center rounded-md border border-border bg-card/50 backdrop-blur-sm px-6 py-3 text-sm font-medium hover:bg-accent transition-all duration-300 min-h-[48px]">
                Sign In
              </Link>
              <Link href="/scoreboard" className="inline-flex items-center justify-center rounded-md border border-border bg-card/50 backdrop-blur-sm px-6 py-3 text-sm font-medium hover:bg-accent transition-all duration-300 min-h-[48px]">
                View Scoreboard
              </Link>
            </div>
          </div>
      ...
      {/* Event Schedule */}
      <section className="event-section-bg mobile-padding mx-auto max-w-6xl py-8 sm:py-12">
        <h2 className="mobile-title tracking-tight mb-6 sm:mb-8 text-center event-text-gradient">Event Schedule</h2>
        
        {/* Day 1 */}
        <div className="mb-8 sm:mb-12">
          <h3 className="mobile-subtitle mb-4 sm:mb-6 text-primary flex items-center gap-2 justify-center sm:justify-start">
          ...
          <div className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-2">
            <div className="mobile-card">
              ...
              <p className="mobile-body text-muted-foreground mb-3">
                Test your knowledge and earn strategic tokens that will be crucial for the next round.
              </p>
              <ul className="mobile-body text-muted-foreground space-y-2">
                <li className="flex items-start gap-2">
      ...
      <section className="mobile-padding mx-auto max-w-6xl pb-12 sm:pb-16">
        <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {!isSignedIn && (
            <>
              <Link href="/sign-up" className="mobile-card group">
                <h4 className="font-semibold text-primary">Register Your Team</h4>
                <p className="mt-2 mobile-body text-muted-foreground">Sign up to participate in the event.</p>
              </Link>
              <Link href="/sign-in" className="mobile-card group">
                <h4 className="font-semibold text-primary">Sign In</h4>
                <p className="mt-2 mobile-body text-muted-foreground">Access your dashboard and competition portals.</p>
              </Link>
              <Link href="/scoreboard" className="mobile-card group">
                <h4 className="font-semibold text-primary">View Scoreboard</h4>
                <p className="mt-2 mobile-body text-muted-foreground">See team rankings and scores.</p>
              </Link>
            </>
          )}
          ...
          <Link href="/admin" className="mobile-card group">
            <h4 className="font-semibold text-primary">Admin Console</h4>
            <p className="mt-2 mobile-body text-muted-foreground">Control round status, manage questions, and oversee the event.</p>
          </Link>
          <Link href="/judge" className="mobile-card group">
            <h4 className="font-semibold text-primary">Judge Console</h4>
            <p className="mt-2 mobile-body text-muted-foreground">Score team presentations and evaluate final round performances.</p>
          </Link>
        </div>
      </section>
